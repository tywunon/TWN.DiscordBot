...
internal class Watcher(WatcherSettings settings, IEnumerable<GuildConfig> guildConfigs, Discord.Client discordClient, Twitch.Client twitchClient, DataStore.DataStore dataStore) : BackgroundService
{
